return {
  ...
  keys = {
    ...
    -- LSP (一覧系は Snacks.picker に統合、ジャンプ系は Lspsaga 等へ)
    {
      'grr',
      function()
    ...
    },
    {
      '<c-/>',
      function()
        -- win オプションで position = "float" を指定する
  ...
  init = function()
    vim.api.nvim_create_autocmd('User', {
      ...
      callback = function()
        ...
        -- Override print for Neovim 0.11+
